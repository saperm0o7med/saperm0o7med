UK Road Safety and Accident Analysis
...
Vehicles Data: Information about the types and conditions of vehicles involved.

Casualties Data: Data concerning the individuals affected by the accidents.

Note: Due to the large file size, the datasets are hosted on Google Drive. You can access them via the link below:

Dataset Link: [https://drive.google.com/drive/folders/1q2uE3DIxVrJ3mwehl2NixP3T50gG9hUg?usp=drive_link ]
...
You can view and run the code directly in Google Colab using the link below:

Colab Notebook: Click here to open the Notebook

Contact Information
LinkedIn: https://www.linkedin.com/in/saperm0o7med
